...
function Checkout() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-yp10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          <form className="bg-white px-12 mt-12">
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        ...
                        <div className="flex flex-1 items-end justify-between text-sm">
                          <div className="text-gray-500">
                            <label
                              htmlFor="quantity"
                              className="in-line mr-5 text-sm font-medium leading-6 text-gray-900"
                            >
                              Qty
                            </label>
                            <select>
